...
class _CastPageState extends State<CastPage> {
  ...
  Future<void> _connectToYourApp(
    ...
    session.sendMessage(CastSession.kNamespaceReceiver, {
      'type': 'LAUNCH',
      'appId': 'com.studioseizh.seizhtv', // set the appId of your app here
    });
  }
  ...
  void _sendMessageToYourApp(CastSession session) {
    ...
    session.sendMessage('urn:x-cast:SeizhTV', {
      'type': 'sample',
    });
  }
  ...
  Future<void> _connectAndPlayMedia(
    ...
    session.sendMessage(CastSession.kNamespaceReceiver, {
      'type': 'LAUNCH',
      'appId': 'com.stud1ioseizh.seizhtv', // set the appId of your app here
    });
  }
